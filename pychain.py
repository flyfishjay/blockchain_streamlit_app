...
input_sender = st.text_input("What is the Senders value?")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_reciever = st.text_input("What is the recievers value?")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("What is the amount?")
